  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <div className="relative">
        ...
        <input type="password" name="password" value={form.password} onChange={onChange} className="w-full bg-white/70 border border-slate-300/70 rounded-lg px-3 py-2 h-12 pl-10 focus:outline-none focus:ring-2 focus:ring-primary/50" placeholder="Password"/>
      </div>
